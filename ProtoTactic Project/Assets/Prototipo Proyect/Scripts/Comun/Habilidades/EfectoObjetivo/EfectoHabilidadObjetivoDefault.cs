//                                  ┌∩┐(◣_◢)┌∩┐
//																				\\
// EfectoHabilidadObjetivoDefault.cs (25/07/2017)								\\
...
namespace MoonAntonio.Glitch.Comun
{
	...
	/// </summary>
	[AddComponentMenu("Moon Antonio/Glitch/Comun/EfectoHabilidadObjetivoDefault")]
	public class EfectoHabilidadObjetivoDefault : EfectoHabilidadObjetivo
	{
		#region Metodos
		/// <summary>
